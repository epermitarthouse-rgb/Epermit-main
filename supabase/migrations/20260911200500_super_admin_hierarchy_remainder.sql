-- Super Admin hierarchy (remainder): apply after manual app_role enum value 'super_admin'.
-- Replaces failed/partial 20260911200000 run — does NOT alter the enum (already present).
-- Idempotent: safe to re-run.

-- ---------------------------------------------------------------------------
-- 1. Platform admin helpers (admin OR super_admin)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 2. Permission resolvers: super_admin receives same effective access as admin
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 3. user_roles RLS: super admins may manage roles
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 4. Governance table RLS (super_admin included)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 5. admin_deactivate_user / admin_activate_user: hierarchy-aware
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 6. Bootstrap super admin (email lookup only — not used at runtime)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 7. RLS + function compatibility: has_role(..., 'admin') -> is_platform_admin()
-- ---------------------------------------------------------------------------
