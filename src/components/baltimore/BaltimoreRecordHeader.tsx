      ...
      <CardContent className="flex flex-wrap items-start justify-between gap-4 pt-6">
        <div>
          ...
          <Link
            ...
            className="text-base font-semibold text-primary hover:underline underline-offset-2"
          >
            {record.recordNumber}
          </Link>
          <div className="mt-2 flex flex-wrap gap-4 text-sm">
            <span>
              ...
              <span className="font-medium text-foreground">{record.permitType}</span>
            </span>
            <span>
            ...
            {record.expirationDate && (
              <span>
                ...
                <span className="text-foreground">{record.expirationDate}</span>
              </span>
            )}
          </div>
        </div>
