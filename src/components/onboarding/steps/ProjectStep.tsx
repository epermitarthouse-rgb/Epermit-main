...
export interface ProjectStepHandle {
  submit: () => Promise<void>;
  toggleSkip: () => void;
  isSkipMode: boolean;
}
...
interface ProjectStepProps {
  ...
  onBack: () => void;
  skipProject: boolean;
  onSkipProjectChange: (skip: boolean) => void;
...
export const ProjectStep = forwardRef<ProjectStepHandle, ProjectStepProps>(
  function ProjectStep(
    { data, onChange, onNext, skipProject, onSkipProjectChange, onLoadingChange },
    ref,
  ) {
    const { user } = useAuth();
    ...
    const toggleSkip = () => {
      const next = !skipProject;
      if (!skipProject) {
        onChange({ ...data, name: "" });
      }
      onSkipProjectChange(next);
    };
    ...
    useImperativeHandle(
      ...
      () => ({
        submit: handleSubmit,
        toggleSkip,
        isSkipMode: skipProject,
      }),
      [data, user, onNext, skipProject, onLoadingChange, onSkipProjectChange],
    );
