...
export const UCI_NAV_SECTIONS: UciNavSection[] = [
  ...
  },
  {
    ...
    note: "Stage 6 Design Review / Class of Service — live Track A workspace.",
    primaryNav: true,
  },
  {
    id: "ciac",
    ...
    note: "Stage 7 CIAC costs, variance, billing hold, and QB status. Refunds are out of scope.",
    primaryNav: true,
  },
  {
    id: "energization",
    ...
    note: "Stages 9–10 inspection release, meter set, and closeout — live record data.",
    primaryNav: true,
  },
  {
    id: "load-profile",
  ...
  },
  {
    ...
    note: "Live provider-resolution evidence. It is not the municipal Jurisdiction Map.",
    primaryNav: true,
  },
  {
    id: "meter-set",
