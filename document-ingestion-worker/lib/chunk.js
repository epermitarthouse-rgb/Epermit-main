...
function isLegacyDoc(fileName, fileType) {
  const lower = fileName.toLowerCase();
  return (lower.endsWith(".doc") && !lower.endsWith(".docx")) || fileType === "application/msword";
}

function isIngestSupported(fileName, fileType) {
